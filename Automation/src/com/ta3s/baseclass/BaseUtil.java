...
public class BaseUtil {
	...
	public void initiate() throws IOException, AWTException, ATUTestRecorderException {	
		...
		if (browser.equalsIgnoreCase("firefox")) {
			...
			driver=new RemoteWebDriver(new URL("http://172.17.0.4:5555/wd/hub"),cap);
	...
	public String getAbsolutePath() throws IOException {
		...
		String path = new File(GetPath.getBasePath()
				+ File.separator+"src/atu.properties").getAbsolutePath();
		//System.out.println("ATU Path "+path);
		return path;
